          ...
          },
          {
            ...
            with: {
              ...
              body: [
                ...
                " ",
                "- [ ] Update `@cdktf/provider-null` to a version compatible with `cdktf@${{ steps.latest_version.outputs.value }}` [here](https://github.com/cdktf/cdktf-local-exec/blob/45a35846c8c7e5bdc600d76344305b1a049ef130/.projenrc.ts#L62). Look up the version [here](https://github.com/cdktf/cdktf-provider-null/releases/).",
                "- [ ] Update `@cdktf/provider-random` to a version compatible with `cdktf@${{ steps.latest_version.outputs.value }}` [here](https://github.com/cdktf/cdktf-local-exec/blob/main/.projenrc.ts#L67). Look up the version [here](https://github.com/cdktf/cdktf-provider-random/releases/).", // @TODO replace with SHA url
                " ",
